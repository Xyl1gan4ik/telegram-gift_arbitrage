        ...
        for user_id in active_users_for_check:
            ...
            try:
                ...
                for gift in auctions:
                    ...
                    gift_link = f"https://t.me/tonnel_network_bot/gift?startapp={gift_id}" if gift_id != 'N/A' else 'Ссылка недоступна'
    ...
    if payment_method == "stars":
        ...
        try:
            ...
            await bot.send_invoice(
                ...
                prices=[LabeledPrice(label="Стоимость", amount=int(price_stars))], # Цена в минимальных единицах (100 для Stars)
